...
decac -p src/test/deca/codegen/valid/others/while.deca > src/test/deca/codegen/valid/others/test-p.deca
decac src/test/deca/codegen/valid/others/while.deca
...
ima src/test/deca/codegen/valid/others/while.ass 2>&1 > src/test/deca/codegen/valid/others/resultatAttendu.txt
