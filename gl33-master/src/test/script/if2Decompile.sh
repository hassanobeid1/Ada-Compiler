...
decac -p src/test/deca/codegen/valid/others/if2.deca > src/test/deca/codegen/valid/others/test-p.deca
decac src/test/deca/codegen/valid/others/if2.deca
...
ima src/test/deca/codegen/valid/others/if2.ass 2>&1 > src/test/deca/codegen/valid/others/resultatAttendu.txt
