...
public abstract class AbstractDeclClass extends Tree {
        ...
        protected abstract void generateTableMethodes(DecacCompiler compiler);

        protected abstract void codeGenInitialization(DecacCompiler compiler);

        public abstract void codeGenInits(DecacCompiler compiler);

        public abstract void codeGenMethodes(DecacCompiler compiler);
